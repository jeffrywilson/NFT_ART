<template>
  <div class="privacy">
    <div class="title-section">
      <h1 class="title-privacy" :class="darkMode ? 'darkText' : ''">
        Privacy & Conditions
      </h1>
      <p class="subtitle-privacy pt-3" :class="darkMode ? 'darkText' : ''">
        SuperFansOnly.art
      </p>
    </div>
    <div class="field">
      <div class="field-body">
        <div class="field">
          <p class="control" :class="darkMode ? 'darkText' : ''">
            SuperFansOnly ("SuperFansOnly", "we", "us", or "our") is committed
            to protecting your privacy. We have prepared this Privacy Policy to
            describe to you our practices regarding the Personal Data (as
            defined below) we collect, use, and share in connection with the
            SuperFansOnly website, mobile app, and other software provided on or
            in connection with our services, as described in our Terms of
            Service (collectively, the "Service"). "NFT" in this Privacy Policy
            means a non-fungible token or similar digital item implemented on a
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            1. Types of Data We Collect. “Personal Data” means data that allows
          ...
          <p class="control px-6" :class="darkMode ? 'darkText' : ''">
          ...
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            b. Information Collected via Technology. As you navigate through and
          ...
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            c. Information Collected from Third-Party Companies. We may receive
          ...
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            ...
            from activity that is publicly visible and/or accessible on
            blockchains. This may include blockchain addresses and information
            regarding purchases, sales, or transfers of NFTs, which may then be
          ...
          <p class="control pl-6" :class="darkMode ? 'darkText' : ''">
            IX. send you a welcome email to verify ownership of the email
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            3. Disclosure of Your Personal Data. We disclose your Personal Data
            as described below and as described elsewhere in this Privacy
            Policy.
          </p>
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            a. Third Party Service Providers. We may share your Personal Data
            with third party service providers to: provide technical
            infrastructure services; conduct quality assurance testing; analyze
            how our Service is used; prevent, detect, and respond to
            unauthorized activities; provide technical and customer support;
            and/or to provide other support to us and to the Service.
          </p>
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            b. Affiliates. We may share some or all of your Personal Data with
            any subsidiaries, joint ventures, or other companies under our
            common control (“Affiliates”), in which case we will require our
            Affiliates to honor this Privacy Policy.
          </p>
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            c. Corporate Restructuring. We may share some or all of your
          ...
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            ...
            Personal Data (as described below), SuperFansOnly may disclose
            ...
            other legal process served on SuperFansOnly; (c) to protect or
            defend the rights or property of SuperFansOnly or users of the
          ...
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            e. Other Disclosures. We may also disclose your Personal Data: to
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            4. Third-Party Websites. Our Service may contain links to
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            5. Third-Party Wallets. To use our Service, you must use a
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            6. Your Choices Regarding Information. You have several choices
            regarding the use of information on our Services:
          </p>
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            a. Email Communications. We may periodically send you newsletters
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            7. Data Access and Control. You can view, access, edit, or delete
            your Personal Data for certain aspects of the Service via your
            Settings page. You may also have certain additional rights:
          </p>
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            a. If you are a user in the European Economic Area or United
            ...
            (ii) request rectification or erasure; (iii) object to or restrict
            the processing of your personal data; and (iv) request portability
            of your personal data. Additionally, if we have collected and
            processed your personal data with your consent, you have the right
          ...
          <p class="control pl-5" :class="darkMode ? 'darkText' : ''">
            c. If you wish to exercise your rights under the GDPR, CCPA, or
            other applicable data protection or privacy laws, please contact us
            by using the “Submit a request” link here or at the address provided
            in Section 13 below, specify your request, and reference the
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            8. Data Retention. We may retain your Personal Data as long as you
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            9. Data Protection. We care about the security of your information
            and use physical, administrative, and technological safeguards to
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            10. Users Outside of the United States. If you are a non-U.S. user
            of the Service, by visiting the Service and providing us with data,
          ...
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            11. Changes to This Privacy Policy. This Privacy Policy may be
            ...
            https://superfansonly.app/privacy. The date the Privacy Policy was
            last revised is identified at the beginning of this Privacy Policy.
            You are responsible for periodically visiting our Service and this
            Privacy Policy to check for any changes.
          </p>
          <p class="control pl-3" :class="darkMode ? 'darkText' : ''">
            12. Questions; Contacting SuperFansOnly; Reporting Violations. If
            ...
            using the “Submit a request” link here or at the following address:
            Wieringerwaardstraat 337, 1024 HM Amsterdam, The Netherlands.
          </p>
        </div>
      </div>
    </div>
